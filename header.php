...
<header>
    ...
    <nav>
        <ul>
            ...
            <li><a href="news.php" class="<?php echo $page == 'news' ? 'active' : ''; ?>">Aktualności</a></li>
            <li><a href="failures.php" class="<?php echo $page == 'failures' ? 'active' : ''; ?>">Awarie</a></li>
            <li><a href="memes.php" class="<?php echo $page == 'memes' ? 'active' : ''; ?>">Memy</a></li>
            <li><a href="authors.php" class="<?php echo $page == 'authors' ? 'active' : ''; ?>">Autorzy</a></li>
        </ul>
    </nav>
</header>
<main>
